...
public class ExternalMergeSort {
    ...
    public ExternalMergeSort(){
         ...
         * @throws IOException
         */
        public ExternalMergeSort(String input, String output) throws IOException{
                boolean verbose = false;
                boolean distinct = false;
                int maxtmpfiles = DEFAULTMAXTEMPFILES;
                Charset cs = Charset.defaultCharset();
                String inputfile = "segments.txt", outputfile = "ss.txt";
                ...
                mergeSortedFiles(l, new File(output), comparator, cs,
        ...
        public static void sort(final File input, final File output)
                throws IOException {
                ExternalMergeSort.mergeSortedFiles(ExternalMergeSort.sortInBatch(input),
                        output);
        }
